    ...
    <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
             &nbsp;Catalogue
                <small>view Author catalogue</small>
            </h1>
           <ol class="breadcrumb">
       ...
       <div class="c_container" width="100%" height="100%">
            <span class="pull-right"><h5 style="color:white">Help <i class="fa-regular fa-circle-question fa-lg" id="myBtn" style="cursor: pointer; color:white" title="Author Card Format"></i></h5></span>
           <h1 style="text-align: center";>Author Catalogue</h1> <br>
            <!--<div class="dropdown"> -->
            ...
            <div class="btn-group" style="padding: 30px">
                ...
                <button class="btn redbtn active">Author Catalogue</button>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content" id="modal-content">
    ...
    <div class="main dragscroll"><img id="map" src="models/1.jpg" ></div>
...
setInterval(function(){
    $('#books').load("models/ajax/books-a.php");
 }, 2000) ;
...
function fetchData(){
    ...
    $.ajax({    
    type: "POST",
    url: "models/ajax/search-books-a.php",             
    dataType: "html", 
    data: {
        search: name
    },                 
