...
<?php include_once('layout/head.php'); ?>
    ...
    height: 100px;">
                          ...
                          <table id="" class="table table-bordered table-striped" >
                                ...
                                $result = $db->prepare("SELECT *,ua.id as uaid FROM tbl_users u INNER JOIN tbl_ualt ua ON u.id=ua.user_id  WHERE course='BSE-SS' AND role = 'Student' AND school='CCT' $date ORDER BY ua.id DESC");
                                $result->execute();
