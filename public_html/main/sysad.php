...
<?php include_once('layout/head.php'); ?>
    <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
             &nbsp; Print User Logs
                <small>System Administrator Logs</small>
            </h1>
           <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="ualt.php"><i class="fa fa-user" ></i> User Logs</a></li>
                        <li class="active">System Administrator Logs&nbsp;&nbsp;</li>
                    </ol>
        </section>
                                             ...
                                             <table width="100%" style=" padding: 0 50px">
                                                    <tr style="vertical-align:top;">
                                                        ...
                                                        <td width="60%"style="border:0; padding: 20px" align="center">
                                                         ...
                                                         <h5>User Logs: System Adminitration</h5>
                                                        </td>
    ...
    height: 100px;">
                            ...
                            <table id="border" width="100%" >
                                <!--Please css gumana kanaa huhu. Yung bootstrap na border-dark di nagana whyyy
                            -->
                            <style>
                                ...
                                $result = $db->prepare("SELECT *,ua.id as uaid FROM tbl_users u INNER JOIN tbl_ualt ua ON u.id=ua.user_id  WHERE role='admin' $date ORDER BY ua.id DESC");
                                $result->execute();
