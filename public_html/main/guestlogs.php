...
<?php include_once('layout/head.php'); ?>
    ...
    height: 100px;">
                            ...
                            <style>
                                ...
                                $result = $db->prepare("SELECT *,ua.id as uaid FROM tbl_users u INNER JOIN tbl_ualt ua ON u.id=ua.user_id  WHERE role='Guest' $date ORDER BY ua.id DESC");
                                $result->execute();
