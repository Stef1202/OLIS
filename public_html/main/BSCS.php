            ...
            <div class="row">
             ...
             <button onclick="myFunction()" class="dropbtn"><i class ="fa fa-filter"></i> Filter</button>
                           ...
                           <a href="BSIT.php">BSIT STUDENTS</a>
                               ...
                               <!-- <a  href="ualt.php" class="btn btn-link pull-right btn-m" ><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Back</a>  -->
                             ...
                             <table id="" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                  ...
                                  <?php
                                        ...
                                        $result = $db->prepare("SELECT *, ua.id as uaid FROM tbl_users u INNER JOIN tbl_ualt ua ON u.id=ua.user_id WHERE course='BSCS' AND role='Student' AND school='CCT' $date ORDER BY ua.id DESC");
