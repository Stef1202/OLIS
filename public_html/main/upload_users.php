            ...
            <div class="card" style="height: 100%; padding-top: 15px;">
                 <div class="card-body">
                    ...
                    <div class='col-md-12'>
                     ...
                     <div class="form-group padd"><label class=" col-md-12 text-left" style='color:red'>Please upload the exported SQL table for the Student accounts: </label></div>
                            <div class="form-group padd" ><label class="col-md-12 text-left">Upload Student Accounts<small class="small-label float-right" style="color:red"> &emsp;(File Type: SQL)</small></label>
...
if (isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($tempname, $folder)) {
        ...
        echo "<script type='text/javascript'>alert('$message');window.location.href='import.php';</script>";

    } else {
        $message = 'Uploading failed';
        echo "<script type='text/javascript'>alert('$message');window.location.href='upload_users.php';</script>";
    }
}
