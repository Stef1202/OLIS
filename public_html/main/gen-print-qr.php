...
<script type="text/javascript">
    ...
    function create() {
      ...
      //  data = "hasas" + data;
        document.getElementById("qrimage").innerHTML += "<img width='40%'  style='border: 1px;' src='https://chart.googleapis.com/chart?chs=500x500&cht=qr&chl=" + encodeURIComponent(data) + "'/>";
    }
